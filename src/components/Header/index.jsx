  ...
  return (
    <div className='bg-rich-black min-h-screen relative overflow-hidden'>
      ...
      <div className='animate__animated animate__fadeInUp'>
        <h1 className='relative font-sora font-semibold text-7xl leading-[1.2] text-white z-10 mt-28 ml-7 md:mt-44 md:ml-28'>
          Hi, I'm <span className='text-wisteria'>Manu</span>
        </h1>

        <p className='text-white font-poppins font-regular ml-7 mt-2 md:ml-28 text-xl z-10'>
          Front end Developer <br className='md:hidden' />and UI/UX Designer
        </p>
      </div>


      <div className='absolute bottom-20 right-11 lg:right-24 lg:mr-24 transform translate-x-1/4 z-10 animate__fadeIn'>
        <img src={Avatar} className='w-72 lg:w-[460px] object-cover' />
      </div>
