...
export default function Card({ data }) {
    ...
    return (
        <>
            ...
            {modalDetails && (
                <div className='fixed bg-black bg-opacity-45 w-full h-full z-50 top-0'>
                    <div className='absolute w-[750px] h-[550px] bg-white m-auto top-[10%] left-[20%]'>
                        <h1>DEU CERTOOOO</h1>
                        <button onClick={() => setModalDetails(false)}>fechar</button>
                    </div>
                </div>
            )}
        </>
